<template>
  <Layout>
    <div style="min-height: 600px">
      ...
      <div v-if="$page.projects&&$page.projects.edges.length>0">
        <el-card
          shadow="hover"
          ...
          <div slot="header">
            <el-row>
              <el-col :span="16">
                <span>
                  <g-link
                    :to="'/project/detail/' + item.node.id"
                  >
      ...
      <el-card
        ...
        v-if="!$page.projects||$page.projects.edges.length==0"
      >
